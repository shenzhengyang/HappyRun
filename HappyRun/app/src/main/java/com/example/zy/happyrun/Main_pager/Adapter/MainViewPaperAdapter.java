package com.example.zy.happyrun.Main_pager.Adapter;
...
public class MainViewPaperAdapter extends PagerAdapter {
    ...
    ArrayList<Map<String, Object>> viewList = new ArrayList<Map<String, Object>>();//Map{"title","view"}
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (viewList.get(position).get("view") instanceof Fragment) {
